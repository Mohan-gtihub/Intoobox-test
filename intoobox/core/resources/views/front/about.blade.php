...
<div class="container">
    ...
    <div class="row w-lg-80 m-auto">
      <div class="col-md-6 pe-md-6">
        <div>
          <img
            src="{{asset('assets/frontend/images/about-img-1.png')}}"
            alt=""
            class="about-img"
          />
        </div>
      ...
      <div class="row mt-12 mt-60">
        <div class="col-md-6 pe-md-6">
          <div class="video-thumb position-relative overflow-hidden">
            ...
            <a
              href="#"
              class="play-video absolute bg-danger"
              data-mfp-src="https://www.youtube.com/embed/YOUR_VIDEO_ID"
            >
              <img
                src="{{asset('assets/frontend/images/play.png')}}"
                alt=""
        ...
        <div class="col-md-6 mt-6 mt-md-0 ps-md-6">
          <div class="d-flex">
            <div>
              <img
                src="{{asset('assets/frontend/images/hand.png')}}"
                alt="hand icons"
                class="img-fluid"
              />
            </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="team-container">
                <img
                  src="{{asset('assets/frontend/images/team-img-1.png')}}"
                  alt=""
                  class="team-img"
                />
            ...
            <div class="col-md-4 mt-6 mt-lg-0">
              <div class="team-container">
                <img
                  src="{{asset('assets/frontend/images/team-img-2.png')}}"
                  alt=""
                  class="team-img"
                />
                <div class="team-info bg-danger text-white px-4 py-3">
            ...
            <div class="col-md-4 mt-6 mt-lg-0">
              <div class="team-container">
                <img
                  src="{{asset('assets/frontend/images/team-img-3.png')}}"
                  alt=""
                  class="team-img"
                />
                <div class="team-info bg-danger text-white px-4 py-3">
