(function ($) {
    ...
    $('.text-editor').summernote({
        ...
        // Appending bluck discount Items
        $('.add-discount-items').on('click', function () {
            var text = $(this).data('text');
            var text1 = $(this).data('text1');
            $('#discount-items-section').append(`
            <div class="d-flex">
            <div class="flex-grow-1">
            <div class="form-group">
        ...
        <div class="flex-btn">
                    <button type="button"
                        class="btn btn-danger remove-bluk-items">
                        <i class="fa fa-minus"></i>
                    </button>
                </div>
        </div>
        ...
        $(document).on('click', '.remove-bluk-items', function () {
            $(this).parent().parent().remove();
        });
