<div class="col-xl-3 col-lg-4">
    <aside class="sidebar">
      <div class="padding-top-2x hidden-lg-up"></div>
        ...
        <section class="card widget widget-featured-posts widget-order-summary p-4">
            ...
            <table class="table">
              ...
              @endif
              <tr>
                <td class="text-lg text-danger">{{__('Order total')}}</td>
                <td class="text-lg text-danger grand_total_set">{{PriceHelper::setCurrencyPrice($grand_total)}}</td>
              </tr>
            </table>
          </section>
      ...
      <section class="card widget widget-featured-posts widget-featured-products p-4">
        ...
        <div class="entry">
          <div class="entry-thumb"><a href="{{route('front.product',$item['slug'])}}"><img src="{{asset('assets/images/'.$item['photo'])}}" class="no-download" alt="Product"></a></div>
