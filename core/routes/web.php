...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => 'permissions:Manage Products'], function () {
            ...
            Route::get('get/item', 'Back\ItemController@getItem')->name('back.get.item');
        ...
        Route::group(['middleware' => 'permissions:Manage Site'], function () {
            ...
            Route::post('home-page8/item/update', 'Back\HomePageController@homepage8itemupdate')->name('back.home8.itme.update');
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::get('/quick/product/{id}', 'Front\FrontendController@quickView')->name('front.product.quick');
        ...
        Route::get('/catalogues', 'Front\FrontendController@catalogues')->name('front.catalogues');
...
Route::post('/shiprocket-webhook', 'Front\FrontendController@shiprocketWebhook');